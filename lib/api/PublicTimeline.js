...
var _PublicTimelineOnly = _interopRequireDefault(require("./PublicTimelineOnly"));
...
class PublicTimeline {
  constructor(_public) {
    ...
    this.only = new _PublicTimelineOnly.default(this);
  }
  ...
  info(contentId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        var res = yield _this3.$http.get("/".concat(contentId, "/info/v2"));
        return res.data;
      } catch (e) {
        console.error(e);
      }
  ...
  timelineContent(contentType, contentId) {
    var _this4 = this;
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        var res = yield _this4.$http.get("/".concat(contentType, "/").concat(contentId));
        return res.data;
      } catch (e) {
        console.error(e);
      }
